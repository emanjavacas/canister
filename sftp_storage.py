...
# ssh.load_system_host_keys()
# ssh.set_missing_host_key_policy(AutoAddPolicy())
# ssh.connect('serv1', username='manjavacas', password='colamora1987?')
# sftp = ssh.open_sftp()
# with sftp.open(os.path.join(find_home(ssh), 'test.json'), mode='a'):
#     os.utime
# f.close()
# ssh.close()

# from tinydb import TinyDB
# db = TinyDB('manjavacas@serv1:~/test.json', policy='autoadd', storage=SFTPStorage)
